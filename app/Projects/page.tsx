    ...
    return (
        <main className={styles.main}>
            ...
            <div className={styles.projectsContainer}>
                <div>
                    <p>
                        Body text for your whole bio. We’ll put in some lorem ipsum to show how a filled-out page might
                        look:
                    </p>
                    <p>
                        ...
                        adipisicing, essential lovely queen tempor eiusmod irure. Exclusive izakaya charming
                        Scandinavian
                ...
                <div className={styles.imageContainer}>
                    <Image src={process.env.NEXT_PUBLIC_BASE_URL + '/xapling-logo.svg'}
                           alt={'Logo'}
                           width={200}
                           height={50}
            ...
            <div className={styles.projectsContainer}>
                <div className={styles.imageContainer}>
                    <Image src={process.env.NEXT_PUBLIC_BASE_URL + '/logo.svg'}
                           alt={'Logo'}
                           width={180}
                           height={50}
                           className={styles.image}
            ...
            <div className={styles.projectsContainer}>
                ...
                <div className={styles.imageContainer}>
                    <Image src={process.env.NEXT_PUBLIC_BASE_URL + '/pia-logo.svg'}
                           alt={'Logo'}
                           width={200}
                           height={50}
                           className={styles.image}
