    ...
    <>
      <head>
        ...
        <meta
          ...
          content="Portfolio Website for Sydney Antoni"
        />
      </head>
      <main>
        <section className={styles.banner}>
          <h2>
            Hey I’m <span className={styles.linearGradient}>Sydney Antoni</span>
          </h2>
        ...
        <section className={styles.historyContainer}>
          ...
          <Image
            src={
              process.env.NEXT_PUBLIC_BASE_URL + "/history-lines/firstLine.svg"
            }
            alt={"first line"}
            width={200}
            height={200}
          ...
          <Image
            src={
              process.env.NEXT_PUBLIC_BASE_URL + "/history-lines/secondLine.svg"
            }
            alt={"second line"}
            width={200}
            height={200}
