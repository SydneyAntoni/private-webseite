...
export default function RootLayout({
  ...
  return (
    ...
    <head>
      ...
      <link rel="manifest" href={process.env.NEXT_PUBLIC_BASE_URL + "/site.webmanifest"}/>
      <link rel="mask-icon" href={process.env.NEXT_PUBLIC_BASE_URL + "/safari-pinned-tab.svg"} color="#2b8eab"/>
